...
export default {
  ...
  methods: {
    startGame() {
      ...
      // Check if the game was previously started, if yes, load the state
      if (this.started) {
        this.loadGameState();
      } else {
    ...
    saveGameState() {
      const gameState = {
        board: { ...this.board }, // Ensure a new object is created for the board
        playing: this.playing,
        started: this.started,
        time: this.time,
        user: this.user,
    ...
    <div class="game">
      ...
      <div class="menu">
        <div class="button-container">
          ...
          <!-- <button v-if="gameWon" @click="submitScore" class="btn">Submit Score</button> -->
        </div>
      </div>
    </div>
